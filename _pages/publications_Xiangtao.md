...
- **2025** Q. Qi; Y. Su, Y. Fan, Z. Yu,  Y. Huang, K. Wong, **X. Li**\*, “scSuperAnnotator: a platform for benchmarking comparison and visualizing automated cellular annotation methods for scRNA-seq data,” **_Nucleic Acids Research_** (2025).（Webserver: https://sciden.aibio-lab.com/scIDEN/index/）  
...
- **2026** Y. Su, Q. Qi, Y. Fan Y. Wang, G. Hao, K. Wong, Y. Wang \*, **X. Li**\*, “PAIR: Reconstructing Single-Cell Open-Chromatin Landscapes for Transcription Factor Regulome Mapping,” **_Advanced Science_** (2026).   
